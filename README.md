...
### Real-world event management application

A web application created to manage activities and checklists for teams during a real event.

The system provides administrative access for staff, real-time checklist updates, team progress monitoring and an automatic ranking system.
...
## 🏛️ DSpace / Institutional Web Project

Currently contributing to the adaptation and customization of an institutional DSpace environment.

The project involves working with an existing open-source platform and understanding its architecture, technologies and integration points.

### Technologies involved

`Angular` · `TypeScript` · `PostgreSQL` · `Node.js` · `Linux` · `Git`

The project is currently being developed within an institutional environment, with parts of the implementation still under preparation for public release.

🔗 **[Institutional DSpace Model](https://joanthonpson.github.io/DSPACE/)**

---

## 📱 Mobile & Web Projects

I also develop academic and personal projects focused on web and mobile applications, including projects using:
...
### 💡 From solving business problems to building software.
